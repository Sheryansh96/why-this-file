#!/usr/bin/env python3
"""
render.py — turn graph.json (from extract.py) into a standalone, interactive
HTML visualization of the change-rationale graph.

Usage:
    python render.py graph.json -o map.html
"""
import json
import argparse
...
def main():
    ...
    html = TEMPLATE.replace("__GRAPH_JSON__", json.dumps(graph_data)).replace("__GRAPH_TITLE__", args.title)
